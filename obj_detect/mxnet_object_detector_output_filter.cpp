#include "mxnet_object_detector_output_filter.hpp"

namespace ocv{

namespace obj_det{

mxnet_object_detector_output_filter::
mxnet_object_detector_output_filter(const std::vector<coco_item_type> &items_to_detect,
...
std::vector<mxnet_object_detector_output_filter::result_type>
mxnet_object_detector_output_filter::
filter(const std::vector<mxnet::cpp::NDArray> &input, cv::Size const &image_size) const
{
...
void mxnet_object_detector_output_filter::set_min_confidence(float input) noexcept
{
    min_confidence_ = input;
}

void mxnet_object_detector_output_filter::
...
void mxnet_object_detector_output_filter::
set_obj_detector_process_size(const cv::Size &obj_detector_process_size) noexcept
{
    obj_detector_process_size_ = obj_detector_process_size;
...
cv::Rect mxnet_object_detector_output_filter::clip_points(float x1, float y1, float x2, float y2,
...
cv::Rect mxnet_object_detector_output_filter::
