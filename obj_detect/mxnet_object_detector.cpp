#include "mxnet_object_detector.hpp"
...
mxnet_object_detector::mxnet_object_detector(std::string const &model_params,
...
mxnet_object_detector::~mxnet_object_detector()
{

}

void mxnet_object_detector::forward(const cv::Mat &input)
{
...
mxnet::cpp::NDArray mxnet_object_detector::get_bboxes() const
{
    return executor_->outputs[2].Copy(Context::cpu());
}

mxnet::cpp::NDArray mxnet_object_detector::get_labels() const
{
    return executor_->outputs[0].Copy(Context::cpu());
}

std::vector<NDArray> mxnet_object_detector::get_outputs() const
{
    return executor_->outputs;
}

mxnet::cpp::NDArray mxnet_object_detector::get_scores() const
{
